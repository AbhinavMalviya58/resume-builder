...
const ModernTemplate: React.FC<BaseTemplateProps> = (props) => {
  const { data, isExporting } = props;

  return (
    <div className={`font-sans resume-template ${!isExporting ? 'p-8 max-w-4xl mx-auto' : ''}`}>
      <div className="bg-white rounded-lg overflow-hidden shadow-lg">
        ...
        <div className="bg-gradient-to-r from-blue-100 to-blue-200 p-6">
          ...
          <div className="flex flex-wrap gap-2 text-blue-800 mt-1">
        ...
        <div className="p-6">
          ...
          {data.summary && (
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-blue-800 border-b-2 border-blue-200 pb-1 mb-3">
                  ...
                  <div className="space-y-4">
                    {data.education.map((edu, index) => (
                      <div key={index} className="border-l-4 border-blue-200 pl-4">
                        ...
                        <div className="text-blue-700">{edu.school}</div>
                        {edu.description && (
                        ...
                        {project.technologies.length > 0 && (
                          <div className="flex flex-wrap gap-1 my-1">
                            {project.technologies.map((tech, i) => (
                              <span key={i} className="bg-white text-blue-600 px-2 py-0.5 rounded text-xs">
                                {tech}
                              </span>
                            ))}
                          </div>
