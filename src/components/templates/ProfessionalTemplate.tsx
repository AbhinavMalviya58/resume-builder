...
const ProfessionalTemplate: React.FC<BaseTemplateProps> = (props) => {
                        ...
                        {project.technologies.length > 0 && (
                          <div className="flex flex-wrap gap-1 my-2">
                            {project.technologies.map((tech, i) => (
                              <span key={i} className="bg-white text-gray-700 px-2 py-0.5 rounded border border-gray-200 text-xs">
                                {tech}
                              </span>
                            ))}
                          </div>
                      ...
                      <div key={index} className="flex items-center">
                        <div className="w-full bg-gray-200 rounded-full h-2.5">
                          <div 
                            ...
                            style={{ width: `${Math.min(90, 70 + Math.random() * 25)}%` }}
                          ></div>
                        </div>
                        <span className="ml-3 text-sm text-gray-700 min-w-0 flex-shrink-0">{skillName}</span>
                      </div>
                    ))}
                  </div>
                </section>
